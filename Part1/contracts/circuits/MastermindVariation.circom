...
//parker mastarmind 8 color 5 holes
...
for (j=0; j<5; j++) {
    ...
    poseidon.inputs[0] <== soln[0];
    poseidon.inputs[1] <== soln[1];
    poseidon.inputs[2] <== soln[2];
    poseidon.inputs[3] <== soln[3];
    poseidon.inputs[4] <== soln[4];
    poseidon.inputs[5] <== privSalt;
